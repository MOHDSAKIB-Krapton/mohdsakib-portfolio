        ...
        <div className="mt-16 backdrop-blur-sm bg-black/20 rounded-lg  p-6">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400 max-w-[80%] mx-auto">
              These computer science concepts demonstrate not just what I know,
              but how I think about software architecture and algorithm
              implementation. Try the terminal commands to see these concepts in
              action!
            </p>
          </div>
        </div>
